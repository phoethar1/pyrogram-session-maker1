...
def session_maker(createbot, api_id, app_hash):
	...
	if re.search("asyncio", pyrogram.__version__):
		...
		async def start_app():
			...
			print(f"\n\nYou can copy your session string, this session belong to you and we will never save or share that session to anyone.\nAlso never share this to anyone!")
